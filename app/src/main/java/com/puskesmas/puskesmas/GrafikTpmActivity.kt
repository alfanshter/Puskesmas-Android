...
import kotlinx.android.synthetic.main.activity_grafik_tpm.*
import org.jetbrains.anko.find
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response

class GrafikTpmActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_grafik_tpm)
        spndamiu()
        ...
        if (spinner != null) {
            ...
            spinner.onItemSelectedListener = object :
                ...
                override fun onItemSelected(
                    ...
                    if (desa =="Kecamatan"){
                        api.getdatatpm_kecamatan().enqueue(object : Callback<GrafikResponse> {
                        ...
                        api.getdatatpm(desa!!).enqueue(object : Callback<GrafikResponse> {
                            override fun onResponse(
                                call: Call<GrafikResponse>,
                                response: Response<GrafikResponse>
                            ) {
